            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-tag"></i> {{__("update Offer")}}</h3>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <form action="{{ route('admin.offers.update',$offer->id) }}"method="POST"class="row">
                            @csrf
                            @method("PUT")
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="form-control @error('name_ar') is-invalid @enderror" 
                                       placeholder="{{__("Arabic Name")}}" value="{{ $offer->name_ar }}" required>
                                @error('name_ar')
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                ...
                                <input type="text" name="name_en" id="name_en" class="form-control @error('name_en') is-invalid @enderror" 
                                       placeholder="{{__("English Name")}}" value="{{ $offer->name_en }}" required>
                                @error('name_en')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                ...
                                <input type="number" step="0.01" name="price" id="price" class="form-control @error('price') is-invalid @enderror" 
                                       placeholder="{{__("Price")}}" value="{{ $offer->price }}" required>
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                ...
                                <input type="datetime-local" name="expire_date" id="expire_date" 
                                       ...
                                       value="{{ $offer->expire_date }}" required>
                                @error('expire_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                          name="description_ar" id="description_ar" rows="5">{{ $offer->description_ar }}</textarea>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                          name="description_en" id="description_en" rows="5">{{ $offer->description_en }}</textarea>
