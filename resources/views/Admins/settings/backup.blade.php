        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{__("Backup & Restore")}}</h4>
                    <p class="text-muted">{{__("Manage data backups and restoration")}}</p>
                </div>
                <div class="card-body">
                    <div class="alert alert-warning">
                        {{__("Backup and restore functionality will be implemented in a future update.")}}
                    </div>
