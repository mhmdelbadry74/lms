                         ...
                         <div class="Typeahead Typeahead--twitterUsers">
                             <div class="u-posRelative d-flex align-items-center">
                                 ...
                                 <input class="demo-input py-0 Typeahead-input form-control-plaintext w-100"
                                     type="text" placeholder="Search Boho .." name="q" title="">
                             </div>
                         </div>
                     </div>
                 </li>
                                                 ...
                                                 <div class="col-4 text-center">
                                                     <div class="bookmark-content">
                                                         <div class="bookmark-icon bg-light-secondary"><i
                                                                 class="stroke-secondary" data-feather="user"></i></div>
                 ...
                 <li class="profile-nav onhover-dropdown px-0 py-0">
                     <div class="d-flex profile-media align-items-center"><img class="img-30"
                             src="../assets/images/dashboard/profile.png" alt="">
                                                 <div class="flex-grow-1"><span>{{ auth('web')->user()->name ?? 'User' }}</span>
                            <p class="mb-0 font-outfit">
                                @if(auth('web')->user() && method_exists(auth('web')->user(), 'getRoleNames'))
                                    @foreach (auth('web')->user()->getRoleNames() as $role)
                                        {{ is_string($role) ? $role : (is_array($role) ? implode(', ', $role) : 'Role') }}
                                    @endforeach
                                @else
                                    Admin
                                @endif
                     ...
                     <ul class="profile-dropdown onhover-show-div">
                         <li><a href="{{ route('admin.index.profile',auth()->user()->id) }}"><i data-feather="user"></i><span>Account </span></a></li>
